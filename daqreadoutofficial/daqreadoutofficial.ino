...
void analogSensors(){
  ...
  allSensors[32] = convertSensor(analogRead(PTUBE2_PIN));
  allSensors[33] = convertSensor(analogRead(PTUBE3_PIN));
  allSensors[34] = convertSensor(analogRead(PTUBE4_PIN));
  allSensors[35] = convertSensor(analogRead(PTUBE5_PIN));
  allSensors[36] = convertSensor(analogRead(PTUBE6_PIN));
  allSensors[37] = convertSensor(analogRead(PTUBE7_PIN));
  allSensors[38] = convertSensor(analogRead(PTUBE8_PIN));
  allSensors[39] = convertSensor(analogRead(PTUBE9_PIN));
  allSensors[40] = convertSensor(analogRead(PTUBE10_PIN));
